...
class Calculator:
    ...
    def __init__(self, root):
        ...
        self.WidgetFrame = Frame(self.MainFrame, bd=10, width=580, height=540, relief=RIDGE, bg='cadet blue')
        self.WidgetFrame.grid(row=1, column=0)
    ...
    def create_button(self, text, row, column):
        btnWidget = Button(self.WidgetFrame, text=text, width=6, height=2, bd=4, bg='cadet blue', font=('arial', 20, 'bold'), command=lambda: self.button_click(text))
